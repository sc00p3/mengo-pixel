var baseTemplateUrl = 'https://raw.githubusercontent.com/sc00p3/mengo-pixel/master/'; //only as default
var subfolders = false; //True means use subfolders images and templates
var vers = "MengoPixel Minimap";
...
function startup() {
  ...
  div.innerHTML = '<link href="https://fonts.googleapis.com/css?family=Pacifico" rel="stylesheet"> <style>     .grecaptcha-badge,#message{display: none !important}     .palette-footer{z-index:5}     .MuiDialog-root .item{background:none} </style> <div id="minimapbg" style="background-image: url(\'https://www.itl.cat/pngfile/big/329-3291777_wallpaper-do-flamengo.png\'); background-size: cover; background-position-x: center; border-radius:12px; position:absolute; right:6px; bottom:6px; z-index:1;"> <div class="posy unselectable" id="posyt" style="background-size:100%; color:#fff; text-align:center; line-height:32px; vertical-align:middle; width:auto; height:auto; padding:6px 8px;"> <div id="minimap-text"></div> <div id="minimap-title" style="line-height: 15px; font-size: 1.3em; font-family: \'Pacifico\', Helvetica, sans-serif;">MengoPixel Minimap</div> <div id="minimap-box" style="position: relative;width:390px;height:280px"> <canvas id="minimap" style="margin-top: 13px; border-radius:12px; background-color: rgba(0, 0, 0, 0.3); width: 100%; height: 100%;z-index:1;position:absolute;top:0;left:0;"></canvas> <canvas id="minimap-board" style="margin-top: 13px; border-radius:12px; width: 100%; height: 100%;z-index:2;position:absolute;top:0;left:0;"></canvas> <canvas id="minimap-cursor" style="margin-top: 13px; border-radius:12px; width: 100%; height: 100%;z-index:3;position:absolute;top:0;left:0;"></canvas> </div> <div id="minimap-config" style="margin-top: 13px; line-height:15px;">  <span id="hide-map" style="cursor:pointer;">Esconder  </span> | <span id="follow-mouse" style="cursor:pointer;">Seguir  </span> | Zoom: <span id="zoom-plus" style="cursor:pointer;font-weight:bold;">&nbsp;+&nbsp;</span>/  <span id="zoom-minus" style="cursor:pointer;font-weight:bold;">&nbsp;-&nbsp;</span> </div> </div>';
...
function loadTemplates() {
  ...
  if (needed_templates.length == 0) {
    if (zooming_in == false && zooming_out == false) {
      minimap_box.style.display = "none";
      minimap_text.style.display = "block";
      minimap_text.innerHTML = "Sem templates aqui.";
